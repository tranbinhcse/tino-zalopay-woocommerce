...
class ZaloPayAtm extends TinoZaloPayGateway {

	public function __construct() {

        $this->id                 = 'zalopay_atmcard';
        ...
        $this->method_title       = __( 'ZaloPay ATM', 'woocommerce' );
        $this->method_description = 'Thanh toán bằng thẻ ATM tại site ZaloPay';
        $this->supports           = array(
          'subscriptions',
          'products',
        ...
        $this->method_description          = 'Thanh toán bằng thẻ ATM cổng thanh toán ZaloPay';
